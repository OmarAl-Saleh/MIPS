...
input [31:0] In_Address,In_Write_Data ; // this refer to ALU reselt as an address and Read data 2 from register file as an write data to store in memory
...
output reg [31:0]  Out_Address,Out_Write_Data ;
